...
public class MoveDirectoryServiceTest {
  ...
  public void testMoveDirectoryWithMoveDirectory() throws Exception {
    ...
    assertEquals("Should contain Hello World in output file", "Hello World",
        new String(Files.readAllBytes(Paths.get(output.toURI()))));
  ...
  public void testMoveFileInDir() throws Exception {
    ...
    assertEquals("Should contain Hello World in output file", "Hello World",
        new String(Files.readAllBytes(Paths.get(originalDirPath))));
